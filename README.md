...
**Frontend**
- React, TypeScript, JavaScript, VueJs
...
## 📦 Open Source
- ⭐ **Laravel Starter Kit** — a production-ready Laravel boilerplate for building scalable SaaS and API platforms
